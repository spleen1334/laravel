...
<section id="promo-alt">
    ...
    <div id="promo2">
        ...
        <a href="">Read more {{ HTML::image('img/right-arrow.png', 'Read more') }}</a>
        {{ HTML::image('img/macbook.png', 'Macbook Pro') }}
    </div><!-- end promo2 -->
...
<section id="pagination">
  {{-- links je built in funkcija za paginaciju --}}
  {{-- links pagination je pozvan iz StoreCtrl@getCategory --}}
  {{ $products->links() }}
