...
<link rel="stylesheet" href="/assets/blog/css/styles.css" type="text/
css" media="screen" />
    ...
    <section id="main">
      ...
      <section id="content">
        ...
        <article>
          ...
          <!-- RELACIJE IZMEDJU MODEL OVDE POSTAJU JASNE -->
          <!-- $post->Author->name >> pristupa Users tabeli i vraca njegov name -->
